...
"""Command
find /root/data/text2shape/rendering -name *nomtl.obj \
...
category = Path(args.obj).parts[-4]
model_id = Path(args.obj).parts[-3]
model_identifier = os.path.split(os.path.split(args.obj)[0])[1]
fp = Path(os.path.abspath(args.output_folder)) / category / model_id / "renderings"

for i in range(0, args.views):
    print("Rotation {}, {}".format((stepsize * i), math.radians(stepsize * i)))

    render_file_path = str(fp / 'r_{0:03d}'.format(int(i * stepsize)))
