# from https://github.com/nv-tlabs/GET3D/tree/master/render_shapenet_data
...
parser.add_argument(
    ...
    help="If true, texture of the objects are not used when rendering."
)
...
print("Import object...")
imported_object = bpy.ops.import_scene.obj(filepath=args.obj, filter_glob="*.mtl", use_edges=False, use_smooth_groups=False, split_mode='OFF')
